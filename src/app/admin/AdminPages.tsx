                    ...
                    <tr key={page.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-950/20 transition-colors">
                      ...
                      <td className="py-4 text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          <button onClick={() => handleEdit(page)} className="p-1.5 bg-white/5 hover:bg-white/10 hover:text-purple-400 border border-white/10 rounded-lg text-gray-400 transition-colors cursor-pointer" title="Edit">
                          ...
                          <button onClick={() => initiateDelete(page.id)} className="p-1.5 bg-white/5 hover:bg-red-950/20 hover:text-red-400 border border-white/10 rounded-lg text-gray-400 transition-colors cursor-pointer" title="Delete">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">

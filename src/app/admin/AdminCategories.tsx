              ...
              <div>
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button onClick={() => handleEdit(parent)} className="p-1.5 bg-white/5 hover:bg-white/10 hover:text-purple-400 border border-white/10 rounded-lg text-gray-400 transition-colors cursor-pointer" title="Edit">
                    ...
                    <button onClick={() => initiateDelete(parent.id)} className="p-1.5 bg-white/5 hover:bg-red-950/20 hover:text-red-400 border border-white/10 rounded-lg text-gray-400 transition-colors cursor-pointer" title="Delete">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">

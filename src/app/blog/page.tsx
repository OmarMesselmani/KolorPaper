...
export const metadata = {
  title: 'المدونة | PaperKolor',
  description: 'مقالات مفيدة ونصائح حول التلوين للأطفال والبالغين.',
};
...
export default function BlogIndex() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
      <div className="mb-12 text-center md:text-right rtl:md:text-right ltr:md:text-left">
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl">
          اكتشف نصائح، أدلة، وفوائد مذهلة للتلوين للأطفال والبالغين.
        </p>
      </div>
      ...
      {allPosts.length > 0 ? (
        ...
        <div className="text-center py-20 bg-gray-50 dark:bg-gray-900/50 rounded-3xl border border-gray-100 dark:border-white/5">
          <p className="text-gray-500 dark:text-gray-400 text-lg">لا توجد مقالات حالياً، تحقق من هذا القسم قريباً!</p>
        </div>
      )}
    </div>
  );

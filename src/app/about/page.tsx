          ...
          <div className="relative bg-white dark:bg-[#0A051A] rounded-[1.9rem] p-6 lg:p-10 flex flex-col lg:flex-row items-center gap-10 overflow-hidden">
            ...
            <div className="flex-1 w-full flex justify-center relative z-10">
              <div className="relative w-full max-w-[280px] sm:max-w-sm aspect-square mt-8 lg:mt-0">
                {/* Outline Image (Back) */}
                <div className="absolute top-0 right-4 sm:right-8 w-3/4 aspect-[3/4] bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 rotate-6 transform transition-transform duration-500 group-hover:rotate-12 flex items-center justify-center p-4">
                  <div className="w-full h-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl flex items-center justify-center">
                    <span className="text-gray-300 dark:text-gray-600 font-bold text-xl">Outline</span>
                  </div>
                </div>
                {/* Colored Image (Front) */}
                <div className="absolute bottom-0 left-0 w-3/4 aspect-[3/4] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 -rotate-3 transform transition-transform duration-500 group-hover:-rotate-6 flex items-center justify-center p-4">
                  <div className="w-full h-full bg-gradient-to-br from-purple-400 to-pink-400 rounded-xl flex items-center justify-center border border-purple-500/20">
                     <span className="text-white font-bold text-xl shadow-sm">Colored</span>
                  </div>
                </div>
              </div>
            </div>
